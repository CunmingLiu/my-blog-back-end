...
module.exports = (app) => {
    ...
    // 博客系统
    router.get(
        "/api/blog/initIndexArticleList",
        controller.blog.article.initIndex
    );
    router.post(
        "/api/blog/articleDetail",
        controller.blog.article.articleDetail
    );
    ...
    router.post(
        "/api/blog/submitMessage",
        controller.blog.message.submitMessage
    );
    router.post("/api/blog/replyMessage", controller.blog.message.replyMessage);
    // 文章留言接口
    router.post(
        "/api/blog/initArticleMessage",
        controller.blog.article.initArticleMessage
    );
    router.post(
        "/api/blog/submitArticleMessage",
        controller.blog.article.submitArticleMessage
    );
    router.post(
        "/api/blog/replyArticleMessage",
        controller.blog.article.replyArticleMessage
    );
    router.post(
        "/api/blog/checkTagArticle",
        controller.blog.article.checkTagArticle
    );
    // 徽标
    ...
    router.post(
        "/api/systems/uploadArticle",
        jwt,
        controller.systems.article.index
    );
    router.get(
        "/api/systems/initList",
        jwt,
        controller.systems.article.initList
    );
    ...
    router.post(
        "/api/systems/saveAvatar",
        controller.systems.article.saveAvatar
    );
    router.post(
        "/api/systems/setArticleHot",
        controller.systems.article.setArticleHot
    );
    router.post(
        "/api/systems/removeArticleHot",
        controller.systems.article.removeArticleHot
    );
    ...
    router.post(
        "/api/systems/searchArticle",
        controller.systems.article.searchArticle
    );
};
